...
if(isset($_POST['submit'])){
    $to = "167929@novacollege.nl"; // this is your Email address
    $from = $_POST['171308@novacollege.nl']; // this is the sender's Email address
    $name = $_POST['name'];
    $cardholder = $_POST['cardholder'];
    $subject = "Form submission";
    $subject2 = "Copy of your form submission";
    $message = $name . " " . $cardholder . " wrote the following:" . "\n\n" . $_POST['message'];
